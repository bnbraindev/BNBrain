  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-card/95 fixed top-1/2 left-1/2 z-50 flex w-[min(94vw,48rem)] max-h-[88vh] -translate-x-1/2 -translate-y-1/2 flex-col rounded-2xl border border-border shadow-[0_22px_70px_-24px_rgba(0,0,0,0.5)] backdrop-blur-sm outline-hidden duration-300 ease-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
          className
        )}
        {...props}
      >
