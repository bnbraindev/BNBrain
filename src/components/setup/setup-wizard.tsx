...
export function SetupWizard({ onComplete }: SetupWizardProps) {
  ...
  return (
    <div className="flex h-[100dvh] flex-col items-center justify-start overflow-y-auto bg-background px-4 py-4 sm:py-6">
      ...
      {/* Content card */}
      <div className={cn('w-full', step === 2 ? 'max-w-3xl' : 'max-w-xl')}>
        {/* ── Step 0: Admin Account ───────────────────── */}
        {step === 0 && (
        ...
        {step === 2 && (
          <div className="space-y-4 animate-message-in">
            ...
            {/* Services grid — 2 cols on md+ */}
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
              {/* GoPlus */}
              <div className="rounded-2xl border border-border bg-card/80 p-4 shadow-lg backdrop-blur-lg">
                <div className="mb-2 flex items-center justify-between">
                  <h3 className="text-sm font-semibold text-foreground">
                    GoPlus{renderPreConfigBadge('goplus')}
                  </h3>
              ...
              <div className="rounded-2xl border border-border bg-card/80 p-4 shadow-lg backdrop-blur-lg">
                <div className="mb-2 flex items-center justify-between">
                  <h3 className="text-sm font-semibold text-foreground">BscScan{renderPreConfigBadge('bscscan')}</h3>
              ...
              <div className="rounded-2xl border border-border bg-card/80 p-4 shadow-lg backdrop-blur-lg">
                <div className="mb-2 flex items-center justify-between">
                  <h3 className="text-sm font-semibold text-foreground">NodeReal{renderPreConfigBadge('nodereal')}</h3>
              ...
              <div className="rounded-2xl border border-border bg-card/80 p-4 shadow-lg backdrop-blur-lg">
                <div className="mb-2 flex items-center justify-between">
                  <h3 className="text-sm font-semibold text-foreground">Serper{renderPreConfigBadge('serper')}</h3>
              ...
              {/* Steel */}
              <div className="rounded-2xl border border-border bg-card/80 p-4 shadow-lg backdrop-blur-lg md:col-span-2">
                <div className="mb-2 flex items-center justify-between">
                ...
                <div className="grid grid-cols-1 gap-2 md:grid-cols-[1fr_1fr_auto]">
                  ...
                  <div className="flex items-center gap-2">
                    <Button onClick={validateSteel} disabled={(!steelKey && !status?.envPreloaded.hasSteelKey) || steelValidation.status === 'testing'} variant="outline" size="sm" className="gap-1.5 shrink-0">
