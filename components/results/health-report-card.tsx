...
export function HealthReportCard({ data }: HealthReportCardProps) {
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className={cn('rounded-lg border px-3 py-2', data.riskyApprovals > 0 && 'border-amber-500/50')}>
            <p className="text-xs text-muted-foreground">Risky Approvals</p>
