...
export function ApprovalRiskCard({ data }: { data: ApprovalRiskCardData }) {
    ...
    <Card className={hasRisk ? 'border-amber-500/30 bg-amber-500/5' : 'border-emerald-500/30 bg-emerald-500/5'}>
      ...
      <CardContent className="space-y-3">
        <div className="grid grid-cols-3 gap-2 text-xs text-center">
          ...
          <div className="rounded-lg border px-2 py-2">
            <p className="text-muted-foreground text-xs">Risky</p>
        ...
        {data.riskySpenders.length > 0 && (
          <div className="space-y-1.5">
            <p className="text-xs font-medium flex items-center gap-1"><ShieldAlert className="size-3 text-red-500" /> Risky Spenders</p>
